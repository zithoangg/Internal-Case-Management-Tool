...
function generateRiskNote() {
    ...
    tableHTML += '</table>';
    document.getElementById('riskNoteOutput').innerHTML = tableHTML;
    return tableHTML; //edited here
}



// can edit
function copyToClipboardtable(tableHTML) { //edited here
    const tempDiv = document.createElement('div');
    tempDiv.innerHTML = tableHTML; // Set the table HTML
...
document.getElementById('generateCaseNote').addEventListener('click', () => {
    ...
    document.getElementById('caseNoteOutput').value = caseNote;
});

document.getElementById('copyCaseNote').addEventListener('click', () => {
    const caseNote = document.getElementById('caseNoteOutput').value;
    copyToClipboard(caseNote);
});
...
document.getElementById('copyRiskNote').addEventListener('click', () => {
    ...
    copyToClipboardtable(riskNoteHTML);
});